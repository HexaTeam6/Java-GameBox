...
public class Land {
	...
	public Land(int width, MainCharacter mainCharacter) {
		...
		land1 = Resource.getResouceImage("resources/dinosaurus/land1.png");
		land2 = Resource.getResouceImage("resources/dinosaurus/land2.png");
		land3 = Resource.getResouceImage("resources/dinosaurus/land3.png");
